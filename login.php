...
<form method="POST">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="loginEmail" maxlength="254" name="kullanici_adi" />
		<p class="helper helper1">Kullanıcı Adınızı Girin:</p>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Şifre: </label>
		<input type="password" id="loginPassword" name="sifre"/>
		<label id="showPasswordToggle" for="showPasswordCheck">Göster
