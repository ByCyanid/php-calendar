! function(e, t) {
    ...
    var Re = "Oca_Şub_Mar_Nis_May_Haz_Tem_Ağu_Eyl_Eki_Kas_Ara".split("_");
    ...
    var Ze = "Pzr_Pzt_Sal_Çrş_Prş_Cum_Cmr".split("_");
    var ze = "Pr_Ps_Sa_Çr_Pr_Cu_Cm".split("_");
    var $e = ae;
    var qe = ae;
    var Je = ae;
    ...
    var wt = /^(?:(Pzr|Pzt|Sal|Çrş|Prş|Cum|Cmr),?\s)?(\d{1,2})\s(Oca|Şub|Mar|Nis|May|Haz|Tem|Ağu|Eyl|Eki|Kas|Ara)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
