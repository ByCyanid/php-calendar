        ...
        var i = n(2),
            ...
            s = function(t) {
                ...
                return i.__extends(e, t), e.prototype.updateDayTable = function() {
                    ...
                    return '<div class="fc-row ' + t.getClass("headerRow") + '"><table class="' + t.getClass("tableGrid") + '"><thead style="background-color:#7579E7;color:#3A0088">' + this.renderHeadTrHtml() + "</thead></table></div>"
        ...
        var r = n(3),
            ...
            H = function() {
                ...
                return t.prototype.constructed = function() {}, t.prototype.getView = function() {
                    ...
                    }), this.contentEl = r("<div class='fc-view-container' style='background-color:#D0EFFF'/>").prependTo(e), this.initToolbars(), this.renderHeader(), this.renderFooter(), this.renderView(this.opt("defaultView")), this.opt("handleWindowResize") && r(window).resize(this.windowResizeProxy = s.debounce(this.windowResize.bind(this), this.opt("windowResizeDelay")))
